...
- When the user says "push everything", they mean literally every uncommitted change — including auto-managed/tooling files such as the `.commandcode/taste/.../taste.md` learning file — should be committed and pushed, not left behind as a local modification. Expects the working tree to end fully clean and in sync with the remote. Confidence: 0.7
