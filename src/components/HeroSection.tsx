...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <div
        className="hero-content-wrapper relative z-[2] mx-auto flex min-h-screen w-full max-w-[1100px] flex-col items-start justify-center py-10 text-left px-6 md:px-8"
        style={{
